...
use App\Livewire\ItemsWarehousePage;
use App\Livewire\ItemsReturnPage;
use App\Livewire\ItemsStatusPage;
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/exporttabelstok', [ExportController::class, 'exportTabelStokStatus'])->name('exporttabelstok');
});
