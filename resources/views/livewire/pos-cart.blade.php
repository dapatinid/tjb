<div class="container mx-auto flex gap-4">
    ...
    <div class="w-1/3 bg-white p-3 shadow-md">
        <div class="sticky top-5">
             @if(count($cartItems) > 0)<button wire:click="refreshPage" class="w-full mx-auto mb-3"><span>Clear Cart</span></button>@endif
            <div class="space-y-4 h-[calc(100vh-11rem)] overflow-y-scroll overscroll-y-auto pe-3" x-data="{ cartItems: @entangle('cartItems').live }">
            ...
            <button wire:click="saveCart" class="w-full mx-auto mb-3 text-white bg-blue-500 hover:bg-blue-700 rounded-lg py-1 mt-2">CO</button>
            @endif
        </div>
    </div>

    
    <div class="w-2/3 rounded-lg py-4 pe-4">
